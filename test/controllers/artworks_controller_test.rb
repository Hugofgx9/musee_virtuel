...
class ArtworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artwork" do
    assert_difference('Artwork.count') do
      post artworks_url, params: { artwork: { autor: @artwork.autor, description: @artwork.description, image: @artwork.image, title: @artwork.title, year: @artwork.year } }
    end
  ...
  test "should update artwork" do
    patch artwork_url(@artwork), params: { artwork: { autor: @artwork.autor, description: @artwork.description, image: @artwork.image, title: @artwork.title, year: @artwork.year } }
